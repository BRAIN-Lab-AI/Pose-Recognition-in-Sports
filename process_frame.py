...
class ProcessFrame:
    ...
    def get_workout_summary(self):
        return {
            'total_reps': self.state_tracker.get('SQUAT_COUNT', 0),
            'improper_reps': self.state_tracker.get('IMPROPER_SQUAT', 0),
            'average_quality': 100.0,  # Placeholder
            'best_rep_quality': 100.0,  # Placeholder
            'depth_consistency': 5.0,   # Placeholder
